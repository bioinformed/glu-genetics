...
from   biozilla.utils         import autofile, hyphen, percent, pair_generator, pick
from   biozilla.union_find    import union_find
from   biozilla.genoarray     import get_genorepr
from   biozilla.genomerge     import get_genomerger
from   biozilla.genodata      import load_map, load_genostream
...
def write_header(outfile,filename,threshold,mincount):
  ...
  outfile.write('  Script Version: %s\n' % __version__)
