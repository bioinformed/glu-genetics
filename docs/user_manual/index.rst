...
* :mod:`transform`: genotype data file manipulation

  The :mod:`transform` module is a utility for converting genotype data files
...
* :mod:`split`: split a genotype file into subsets

  The :mod:`split` module splits an input matrix into multiple output files
...
* :mod:`qc.summary`: assay and sample completion

  The :mod:`qc.summary` module looks at genotype data by locus and by sample,
...
* :mod:`qc.dupcheck`: duplicate sample analysis
  The :mod:`qc.dupcheck` module looks at genotype data and identifies three categories of duplicates:
...
* :mod:`qc.concordance`: genotype concordance between data sets
...
* :mod:`assoc.logit1`: Single-locus association tests of dichotomous and
  unordered polytomous outcomes with optional covariates

* :mod:`assoc.linear1`: Single-locus association tests of continuous outcomes
