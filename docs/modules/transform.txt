+++++++++++++++++++++++++++++++++++++++++++++++++++++
The Genotype Library and Utilities - Transform module
+++++++++++++++++++++++++++++++++++++++++++++++++++++

The Transform module performs various transformations on genotype data files
...
--------------------------------------
  ...
  --merge	 Genotype merge algorithm and optional consensus threshold used to form a consensus genotypes.
...
-----------------------
  ...
  -a  --renamealleles  Rename alleles based on file of locus name, tab, old alleles (comma separated), tab, new alleles (comma separated)
