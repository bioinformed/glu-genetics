...
information in all files will be considered during tag selection stage.
...
This file is specified with the '-B' option. The bin number will appear
multiple times as we output all the information for that bin.  This format
is an expanded version of the output produced by the program ldSelect
(Carlson et al., 2004).  The following table describes the information
...
This file is specified by the '-o' option. The first line is a header and
